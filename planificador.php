...
<head>
    ...
    <title>HappyEat - Planificador</title>
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="bi bi-calendar3  nav-link" href="#"> Planificador <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <section class="contenido">
        ...
        <div class="texto">
            ...
            <h2>¡Disfruta del Planificador de menus de <spam class="empresa"> HappyEat!</spam></h2>
                <br><br><br>
            ...
            <div class="tabla">
                ...
                <button onclick="GenerarMenu()" class="btn_menu">Generar Menu</button>
    
                <?php
                include "php/tablas_menu.php";
                ?>
