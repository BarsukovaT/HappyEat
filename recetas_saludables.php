...
<head>
    ...
    <title>HappyEat - Recetas Saludables</title>
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown active">
                    <a class="bi bi-receipt-cutoff nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Recetas<span class="sr-only">(current)</span></a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="bi bi-heart dropdown-item" href="#"> Saluables</a>
    ...
    <section class="contenido">
        ...
        <div class="texto">
            ...
            <?php
                include "php/recetas_carrusel.php";
            ?>
    ...
    <script src="JS/render_recetas.js" type="application/javascript"></script>
